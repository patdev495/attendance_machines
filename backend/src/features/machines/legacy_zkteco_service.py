"""Legacy ZKTeco operations kept out of the Hanvon Attendance Machine runtime.

Current product runtime uses Hanvon. Router endpoints for these operations return
HTTP 410, but status shapes remain importable for old frontend polling paths.
"""
import base64
...
from database import EmployeeFingerprint, EmployeeMetadata, SessionLocal
...
except Exception:  # pragma: no cover - legacy module is not used in Hanvon runtime
    ZK = None  # type: ignore
...
# Legacy enrollment progress state.
