        ...
        <table>
          ...
          <tbody>
            ...
            <tr v-for="row in items" :key="row.id">
              <td class="emp-id">{{ row.employee_id }}</td>
...
.emp-id { font-weight: 600; color: var(--primary-light); }
.time-col { color: var(--text-main); font-family: 'JetBrains Mono', monospace; font-size: 0.9rem; }
