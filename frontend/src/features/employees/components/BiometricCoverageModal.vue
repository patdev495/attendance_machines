              ...
              <div v-else class="status-list">
                <div v-for="m in sortedResults" :key="m.ip" class="status-card" :class="m.status.toLowerCase()">
                  ...
                  <div class="machine-meta">
                    <span class="machine-label">{{ $t('device.machine') }}</span>
                    <router-link :to="{ name: 'machines-detail', params: { ip: m.ip } }" @click="close" class="machine-ip machine-link" title="Quản lý thiết bị này">
                      {{ m.ip }}
